...
/**
 * Reads {@code Authorization: Bearer <token>}, verifies it, loads the user, and populates the
 * Spring {@link org.springframework.security.core.context.SecurityContext}.
 *
 * <p>Missing / invalid tokens are silently ignored here; the security filter chain decides whether
 * a given route requires authentication. This is the Spring idiom that replaces the Nest global
 * {@code JwtAuthGuard + @Public} pair.
 */
@Component
