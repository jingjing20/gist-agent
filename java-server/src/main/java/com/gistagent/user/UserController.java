...
public class UserController {
  ...
  public Map<String, Boolean> updateProfile(
      @AuthenticationPrincipal AuthenticatedUser user, @RequestBody UpdateProfileRequest body) {
  ...
  public Map<String, Boolean> updatePassword(
      @AuthenticationPrincipal AuthenticatedUser user, @RequestBody UpdatePasswordRequest body) {
