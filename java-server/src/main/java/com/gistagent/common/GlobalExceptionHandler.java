...
/**
 * Produces the same JSON error shape as Nest's default HttpExceptionFilter: { "statusCode": 403,
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, Object>> handleAuth(AuthenticationException ex) {
    return build(
        HttpStatus.UNAUTHORIZED, ex.getMessage() == null ? "Unauthorized" : ex.getMessage());
  }
