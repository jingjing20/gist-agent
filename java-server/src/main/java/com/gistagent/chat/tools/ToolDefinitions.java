 ...
 *
 * SDK 本身的 FunctionParameters 需要逐键 putAdditionalProperty，
 * 这里提供一个短路径：直接收一份 {@code Map<String, Object>}（JSON schema）
 * 转成 JsonValue。调用方只关心 schema 形状，不用跟 SDK 的 JsonField 打交道。
 */
public final class ToolDefinitions {

	private ToolDefinitions() {}

	public static ChatCompletionTool functionTool(String name, String description,
