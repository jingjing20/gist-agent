<template>
    <div class="chat-view-container">
        <ChatSidebar :collapsed="isSidebarCollapsed" @collapse="isSidebarCollapsed = true" />
        <ChatDetail @toggle-drawer="isDrawerOpen = !isDrawerOpen" @open-sidebar="isSidebarCollapsed = false" :sidebar-collapsed="isSidebarCollapsed" :drawer-open="isDrawerOpen" />
