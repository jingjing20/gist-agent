...
echarts.use([BarChart, LineChart, PieChart, ScatterChart, RadarChart, FunnelChart, TitleComponent, TooltipComponent, GridComponent, LegendComponent, CanvasRenderer]);
