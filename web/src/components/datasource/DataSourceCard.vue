    ...
    <div class="ds-card">
        ...
        <div class="card-footer">
            <div class="action-buttons">
                <button v-if="!ds.is_local && isCreator" class="action-btn" @click="emit('edit', ds)" title="编辑信息">
                    <i class="fas fa-edit"></i>
                </button>
                <button v-if="!ds.is_local" class="action-btn" @click="emit('upload', ds)" title="上传文件">
                    <i class="fas fa-upload"></i>
                </button>
                <button v-if="!ds.is_local && isCreator" class="action-btn" @click="emit('grant', ds)" title="授权管理">
                    <i class="fas fa-user-shield"></i>
                </button>
                <button class="action-btn" @click="emit('view-tables', ds)" title="查看数据表">
                    <i class="fas fa-table"></i>
                </button>
                <button v-if="!ds.is_local && isCreator" class="action-btn delete" @click="emit('delete', ds.id)" title="删除数据源">
