        ...
        <div v-if="modelValue" class="modal-overlay">
            <div class="modal da-modal" :class="{ 'wide-modal': file && isExcel }">
                ...
                <div class="da-form">
                    ...
                    <div v-if="error" class="da-error-msg"><i class="fas fa-exclamation-circle"></i> {{ error }}</div>
                </div>

                <div class="modal-footer">
                    <button class="btn-da-ghost" @click="emit('update:modelValue', null)">取消</button>
                    <button class="btn-da-primary" :disabled="!file || !canSubmit || submitting" @click="handleSubmit">
